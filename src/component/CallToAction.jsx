...
function CallToAction() {
    return (
        <>
            <div className='px-3'>
                <div class="my-10 mx-auto flex max-w-xl flex-col rounded-xl bg-white rounded-xl shadow-lg outline outline-gray-200 py-10 px-4 text-center sm:px-10 lg:max-w-screen-lg lg:flex-row lg:text-left">
                    ...
                    <div class="lg:pl-10">
                        <span class=" text-2xl font-bold  md:text-3xl md:leading-none">
                            Startup Branding
                            In a Nutshell
                        </span>
                        <p class="mt-4 text-md md:pr-28">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis numquam qui ratione. Ullam excepturi repellendus obcaecati recusandae laudantium!</p>
